...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $urlRouterProvider.otherwise("/dashboards/dashboard_3");
    ...
    $stateProvider 
		...
		.state('catalogo.indicador', {
            url: "/indicador",
            templateUrl: "views/catalogoindicador.html",
            data: { pageTitle: 'Catálogo de indicadores' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
		...
		.state('catalogo.metaindicador', {
            url: "/metaindicador",
            templateUrl: "views/catalogometaindicador.html",
            data: { pageTitle: 'Meta de indicador' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
		...
		.state('catalogo.escalaindicador', {
            url: "/escalaindicador",
            templateUrl: "views/catalogoescalaevaluacion.html",
            data: { pageTitle: 'Escala de indicador' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
		...
		.state('catalogo.tipoindustria', {
            url: "/tipoindustria",
            templateUrl: "views/catalogotipoindustria.html",
            data: { pageTitle: 'Tipo de industria' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
		...
		.state('catalogo.unidadmedida', {
            url: "/unidadmedida",
            templateUrl: "views/catalogounidadmedida.html",
		...
		.state('catalogo.centrodetrabajo', {
            url: "/centrodetrabajo",
            templateUrl: "views/catalogocentrodetrabajo.html",
            data: { pageTitle: 'Centro de trabajo' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
		...
		.state('catalogo.tipocombustible', {
            url: "/tipocombustible",
            templateUrl: "views/catalogotipocombustible.html",
            data: { pageTitle: 'Tipo de combustible' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
		...
		.state('catalogo.factoremision', {
            url: "/factoremision",
            templateUrl: "views/catalogofactoremision.html",
            data: { pageTitle: 'Tipo de combustible' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
		...
		.state('catalogo.personaIndividual', {
            url: "/individual",
            templateUrl: "views/registroPersonaIndividual.html",
            data: { pageTitle: 'Registro de persona Individual' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
		...
		.state('catalogo.personaJuridica', {
            url: "/juridica",
            templateUrl: "views/registroPersonaJuridica.html",
            data: { pageTitle: 'Registro de persona Juridica' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
